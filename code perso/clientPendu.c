...
int main(int argc, char **argv) {
  ...
  void demandeLettres(char buff_lettres[]){
    ...
    printf("error\n");};*///supp car on lit tout d'un coup avant
...
//a quoi ca sert d'en faire un thread ? -> mettre dans le prgm principal ?
  ...
  /*FAIRE 2 THREAD,
  - 1 qui demande a ce client les lettres puis envoie au serveur la lettre
  - l'autre qui s'occupe des reponses des autres clients et nouvelles (dé)connexions envoyé par le serveur
  */
